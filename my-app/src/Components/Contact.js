      ...
      <div className="container-fluid pt-5 d-flex justify-content-center text-light flex-grow-1">
        <div className="row flex-column flex-md-row justify-content-center w-100">
          <div className="col-lg-6">
              ...
              <p className="contact-body mt-0 pt-0" data-aos="fade-right" data-aos-delay="200" data-aos-duration="5000">Thank you for visiting my site! If you would like to get in touch with me my contact information is listed below. You can contact me directly by email, or if you would like to leave a quick and simple message just fill out the contact form and I will get back to you as soon as I can. Also, feel free to connect with me through social media.</p>
              <p className="contact-body pb-2 d-flex justify-content-center" data-aos="fade-left" data-aos-delay="200" data-aos-duration="5000">johncrawforddesign@gmail.com</p>
              
          </div>
          <div className="col-lg-6 contact-input px-5" data-aos="zoom-in-down" data-aos-delay="200" data-aos-duration="5000">
