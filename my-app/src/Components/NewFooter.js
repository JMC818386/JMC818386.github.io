...
const Footer = () => {
  return (
	<div className={styles.desktopMLogoLeftMenu} style={{ paddingTop: '50px' }}>
	  <div className={styles.top}>
		<div className={`${styles.logoContainer} footer-hide-mobile`}>
		...
		<div className={`${styles.menu} footer-hide-mobile`}>
		...
		<div className={`${styles.socialIcons} footer-social-center-mobile`}>
