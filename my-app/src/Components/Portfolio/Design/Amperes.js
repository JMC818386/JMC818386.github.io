    ...
    <div className="container mb-5">
      <div className="row">
        <div className="col-md-6 d-flex flex-md-row flex-column align-items-center m-3">
          <img src={AmperesAnd} alt="Ampere's & Co." className="img-square" />
          
          <div className="ml-md-4 mt-4 mt-md-0 flex-grow-1">
            <p className="text-light port-body-text m-5">
              ...
              culpa qui officia deserunt mollit anim id est laborum. Some more text again.
            </p>
          </div>
        </div>
      </div>
