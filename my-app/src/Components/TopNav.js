    ...
    <div className="sticky-navbar">
        <nav className="navbar navbar-expand-lg navbar-dark">
            ...
            <div className="d-flex justify-content-center" style={{ position: 'relative', right: '50px' }}>
                ...
                <a className="p-2 social-links" target="_blank" rel="noreferrer" href="https://github.com/JMC818386" ><img src={Github} style={{ width: 30 }} alt="GitHub Profile"/></a>
                
                <a className="p-2 social-links" target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/john-michaelcrawford" ><img src={LinkedIn} style={{ width: 30 }} alt="LinkedIn Profile"/></a>

                <a className="p-2 social-links" target="_blank" rel="noreferrer" href="https://www.facebook.com/" ><img src={Facebook} style={{ width: 30 }} alt="Facebook Profile"/></a>

                <a className="p-2 social-links" target="_blank" rel="noreferrer" href="https://www.instagram.com/" ><img src={Instagram} style={{ width: 30 }} alt="Instagram Profile"/></a>

                <a className="p-2 social-links" target="_blank" rel="noreferrer" href="https://www.behance.com/" ><img src={Behance} style={{ width: 30 }} alt="Behance Profile"/></a>
